...
class ContactTestCase(APITestCase):
    ...
    def test_update_contact(self):
        ...
        self.assertEqual(
            ContactInfo.objects.get(pk=self.contact.pk).email, "new_contact@info.com"
        )
...
class ProductTestCase(APITestCase):
    def setUp(self):
        ...
        self.product = Product.objects.create(
            title="Test", model="Test", launched_at="2015-01-01"
        )
...
class VendorTestCase(APITestCase):
    def setUp(self):
        ...
        self.vendor = Vendor.objects.create(
            title="Test", level=0, contact=self.contact, debt_to_supplier=100
        )
    ...
    def test_update_vendor(self):
        ...
        product2 = Product.objects.create(
            title="Test2", model="Test2", launched_at="2015-01-02"
        )
        data = {
            "title": "New Vendor",
            "level": 0,
    ...
    def test_retrieve_vendor(self):
        ...
        self.assertEqual(
            response.data["products"][0]["title"], self.vendor.products.first().title
        )
